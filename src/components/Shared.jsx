...
export const Logo = ({ size = 52, showText = true, className = '' }) => (
  <div className={`flex items-center gap-4 ${className}`}>
    <img src="/Logo.png" alt="Cénit" style={{ width: size, height: 'auto' }} />
    {showText && (
      <div className="leading-none">
        <div className="text-xl md:text-2xl font-semibold tracking-[0.12em] text-[#E8C77E]">CÉNIT</div>
        <div className="text-[10px] md:text-xs tracking-[0.2em] text-[#6A655C] mt-1">BARBERÍA</div>
      </div>
    )}
  </div>
);
